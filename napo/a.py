...
# ===============================
gdf_napo = gdf_parroquias[gdf_parroquias["DPA_DESPRO"] == "NAPO"].copy()
...
ax.set_title("Mapa de Calor: Vendedores de Libros por Parroquia - Napo", fontsize=14)
ax.axis("off")
...
m.save("mapa_interactivo_napo.html")
print("✅ Mapa interactivo guardado como 'mapa_interactivo_napo.html'")
